...
class QAHandler:
    ...
    async def validate_with_llm_batch(self, items: List[Dict[str, str]], target_lang: str, term_base: Optional[Dict[str, Dict[str, Any]]] = None) -> List[List[str]]:
        ...
        combined_prompt += (
            ...
            f"5. Appropriate use of RELEVANT_TRANSLATIONS:\n"
            f"   - Names should follow the term base\n"
            f"   - Other terms and phrases should either match the term base OR use justified alternative translations that better suit the context\n"
            f"   - Any deviations from the term base must serve to improve clarity, naturalness, or effectiveness\n"
            ...
            f"- Balance between term base consistency and contextual appropriateness\n"
